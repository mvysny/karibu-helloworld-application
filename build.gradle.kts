...
dependencies {
    ...
    implementation("com.github.mvysny.karibudsl:karibu-dsl-v10:$karibudsl_version")
    ...
    // test support
    testImplementation("com.github.mvysny.kaributesting:karibu-testing-v10:1.1.20")
